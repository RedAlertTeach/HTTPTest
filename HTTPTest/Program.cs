...
namespace HTTPTest
{
    ...
    public class Service : IService
    {
        ...
        public string total_letter_count(string s)
        {
            ...
            // declare a string with all letters of the alphabet so we can search iteratively
            ...
            // iterate through the alphabet to get each letter count
            foreach (char c in alphabet)
            {
                ...
                letterCount.letter = c;
                letterCount.count = (from n in keyValuePair.value
                                    where char.ToLower(n) == c    // match all cases
                                    select n).Count();

                // add the LetterCount object to the LetterCounts list
                letterCounts.counts.Add(letterCount);
            }
